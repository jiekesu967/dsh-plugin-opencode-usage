 ...
 * 套餐文档整体上限为 5 小时 $12、每周 $30、每月 $60;其中 DeepSeek V4 Pro
 * 与 DeepSeek V4 Flash 的月度包含用量为 $15。本插件据此把百分比换算为:
 *
 ...
 * 整体套餐上限仍为 5 小时 $12 / 每周 $30 / 每月 $60;但 DeepSeek V4 Pro
 * 与 DeepSeek V4 Flash 的月度包含用量已调整为 $15,默认按此模型口径计算。
 * 若官方再次调整,可在 profile 的 cordis.patch.yml 覆盖本插件的 limits 配置。
 */
